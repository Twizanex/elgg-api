...
/**
 * Web service to user number
 *
 * @param string $context - context
 *
 * @return array
 */
function user_number($context)
{
    if($context=="all"){
		$return["register_user"] = get_number_users(true);
	}else if($context=="active"){
		$return["active_user"] = json_decode( get_online_users(array('seconds' => 6000)) );
	}else{
		$return["message"]="please give context value";
	}
...
elgg_ws_expose_function('user.number',
	"user_number",
	array(
